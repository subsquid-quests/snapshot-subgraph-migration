...
const GnosisSafeProxyFactory_v100 = __importStar(require("./abi/GnosisSafeProxyFactory_v1.0.0"));
const GnosisSafeProxyFactory_111 = __importStar(require("./abi/GnosisSafeProxyFactory_v1.1.1"));
const GnosisSafeProxyFactory_v130 = __importStar(require("./abi/GnosisSafeProxyFactory_v1.3.0"));
...
exports.processor = new evm_processor_1.EvmBatchProcessor()
    ...
    .addLog({
    address: [
        exports.CONTRACT_ADDRESS_GNOSIS_SAFE_V1_0_0,
        exports.CONTRACT_ADDRESS_GNOSIS_SAFE_V1_1_1,
        exports.CONTRACT_ADDRESS_GNOSIS_SAFE_V1_3_0,
    ],
